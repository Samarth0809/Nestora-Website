      ...
      <div className="container">
        <div className="hero-wrapper">
          ...
          <div className="hero-visual animate-fade-in" style={{ animationDelay: '0.3s' }}>
            <img 
              src="/kirana-delivery-hero.jpg" 
              alt="Hyperlocal kirana store connected with fast delivery to happy customers" 
        ...
        {/* Connection Flow */}
        <div className="connection-section animate-fade-in" style={{ animationDelay: '0.6s' }}>
